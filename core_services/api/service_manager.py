...
SERVICE_GROUPS: Dict[str, List[str]] = {
    ...
    ServiceGroup.STORAGE: [
        ...
        "alpr-kafka-consumer",
        "alpr-dlq-consumer",
        "alpr-metrics-consumer",
        "alpr-query-api",  # Hosts this dashboard - cannot be stopped from here
    ],
    ServiceGroup.SEARCH: [
        "alpr-opensearch",
...
RAM_ESTIMATES: Dict[str, int] = {
    ...
    ServiceGroup.STORAGE: 500,  # Includes DLQ, Metrics consumers, and Query API
    ServiceGroup.SEARCH: 1500,
    ServiceGroup.ALERTS: 50,
    ServiceGroup.MONITORING: 1200,  # Increased for Tempo (~512MB)
    ServiceGroup.ANALYTICS: 700,
    ServiceGroup.MLOPS: 500,  # MLflow
...
SERVICE_DEPENDENCIES: Dict[str, List[str]] = {
    ...
    ServiceGroup.MLOPS: [ServiceGroup.STORAGE],  # MLflow depends on TimescaleDB and MinIO
}
...
<body>
    ...
    <script>
        ...
        function renderGroups(data) {
            ...
            const groupOrder = ['kafka', 'storage', 'search', 'alerts', 'monitoring', 'analytics', 'mlops', 'optional'];
