...
**File**: `core_services/monitoring/grafana/dashboards/alpr-overview.json`
...
**File**: `core_services/monitoring/grafana/dashboards/kafka-database.json`
...
1. `core_services/monitoring/grafana/dashboards/alpr-overview.json`
2. `core_services/monitoring/grafana/dashboards/kafka-database.json`
