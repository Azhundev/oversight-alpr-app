...
**Location**: `core-services/monitoring/grafana/dashboards/elasticsearch-search.json`
...
curl -X PUT 'http://localhost:9200/alpr-events-2025.12-v2' \
  -H 'Content-Type: application/json' \
  -d @core-services/search/opensearch/templates/alpr-events-template.json
...
- **Configuration**: `config/elasticsearch.yaml`
- **Dashboard**: `core-services/monitoring/grafana/dashboards/elasticsearch-search.json`
